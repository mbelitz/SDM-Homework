...
These variables may be useful in describing the variance in temperature and precipitation that are representitive of the seasonality that is characteristic of chaparral ecosystems. 
